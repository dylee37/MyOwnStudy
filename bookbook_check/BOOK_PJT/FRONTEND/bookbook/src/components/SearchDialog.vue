<template>
  <Teleport to="body">
    <div v-if="isOpen" class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-start justify-center p-4"
      ...
      <div class="bg-white rounded-xl w-full max-w-lg mt-20 max-h-[80vh] flex flex-col">
        ...
        <div class="p-4 border-b border-[#E0E0E0]">
          <div class="flex items-center gap-3">
            ...
            <input v-model="searchQuery" type="text" placeholder="제목 또는 작가로 검색"
        ...
        <div class="flex-1 overflow-y-auto p-4">
          ...
          <div v-else class="space-y-3">
            <button v-for="book in filteredBooks" :key="book.id" @click="handleBookClick(book)"
