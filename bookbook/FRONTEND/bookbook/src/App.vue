...
const mockBooks = [
  {
    ...
    author: '이미예',
    category: '판타지',
    cover_url: 'https://images.unsplash.com/photo-1723220217551-5b5a8a578758?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400',
    rating: 9.2,
    commentCount: 24
  },
  {
    ...
    author: '정문정',
    category: '자기계발',
    cover_url: 'https://images.unsplash.com/photo-1660606422784-5a18d4be40fe?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400',
    rating: 8.8,
    commentCount: 18
  },
  {
    ...
    author: '김난도 외',
    category: '경제/경영',
    cover_url: 'https://images.unsplash.com/photo-1760120482171-d9d5468f75fd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400',
    rating: 8.5,
    commentCount: 12
  },
  {
    ...
    author: '김호연',
    category: '소설',
    cover_url: 'https://images.unsplash.com/photo-1633248382168-031c2a6084e8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400',
    rating: 9.5,
    commentCount: 32
  },
  {
...
const handleSubmitComment = ({ text, isVoice, rating }) => {
  ...
  alert(`${isVoice ? '음성' : '텍스트'} TOKTOK이 등록되었습니다!\n평점: ${rating}/10`);
